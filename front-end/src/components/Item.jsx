...
const Item = () => {
  return (
    <a href="/" className="flex flex-col gap-3">
      <img
        src="https://a0.muscache.com/im/pictures/hosting/Hosting-1453650258452484566/original/7218402d-d028-416d-82ce-9fbb31677ced.jpeg?im_w=480"
        alt="Imagens"
      ...
      <div>
        ...
        <p className="truncate text-gray-600">
          ...
          churrasqueira privativas. Estacionamento para dois carros dentro de
          prédio. Com uma área externa com vista panorâmica da praia das Dunas.
          O espaço Cobertura duplex em frente a praia das Dunas de Cabo Frio. O
          ...
          Praia do Forte (indo de carro). Cobertura fica no 4° andar.{" "}
        </p>
      </div>
      <p>
